# Educational Resources for China–Africa AI Compute Faculty Development Program (Phase 1)

This directory contains comprehensive educational materials for Phase 1 of the China–Africa AI Compute Faculty Development Program.
...
```
editions/china-africa-faculty/phase-1/
